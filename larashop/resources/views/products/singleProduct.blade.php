		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 product-details">
					...
					<h3 class="p-price"> {{ number_format($product->price,2,'.',' ')}} $</h3>
					<h4 class="p-stock">Mavjudligi: <span>Mavjud</span></h4>
					{{-- <div class="p-rating">
					...
					<div class="d-fles">
						@if(Auth::user())
							<a href="#" class="site-btn  bg-success">SAVATCHAGA QO'SHISH</a>
							<a href="#" class="site-btn">HOZIR XARID QILISH</a>
						@else
							<a href="{{route('login')}}" class="site-btn-white btn  btn-outline-success">Mahsulotga buyurtma berish uchun tizimga kiring</a>
