				...
				<div class="col-lg-8">
					<div class="cart-table">
									...
									<tr>
										...
										<td class="product-col">
											...
											<div class="pc-title">
												...
												<p> <span id="productPrice">{{number_format($item->product->price,2,'.',' ')}}</span> $</p>
											</div>
										</td>
										{{-- <td class="quy-col">
											<div class="quantity">
						...
						<div class="total-cost">
							<h6>Total Amount <span>{{number_format($totalPrice,2,'.',' ')}} $ </span></h6>
						</div>
					</div>
				</div>
				<div class="col-lg-4 card-right align-self-center">
{{--						<a href="{{ route('order.sendOrder') }}" class="site-btn-command btn  btn-outline-success">Hoziroq buyurtma bering</a>--}}
						<a href="{{url('/')}}" class="site-btn-command btn  btn-outline-secondary">Kontentni sotib olish</a>
				</div>
			</div>
		</div>
	</section>
