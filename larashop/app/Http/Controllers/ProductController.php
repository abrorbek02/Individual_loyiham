...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        if($categories->isEmpty()){
            Alert::warning("Har qanday mahsulotni qo'shishdan oldin toifani qo'shing");
    ...
    public function store(ProductRequest $request)
    {
        ...
        Alert::success('Yangi mahsulot', "Yangi mahsulot muvaffaqiyatli qo'shildi");
    ...
    public function update(Request $request, $id)
    {
        ...
        Alert::success('Mahsulot muvaffaqiyatli yangilandi','');
    ...
    public function Remove(Product $product){
        $product->delete();
        Alert::success('Mahsulot muvaffaqiyatli olib tashlandi','');
        return back();
    }
    ...
    public function Restore($id){
        ...
        $products = Product::all();
        $categories = Category::all();
        Alert::success('Mahsulot muvaffaqiyatli tiklandi',"Endi mahsulot mijozingizga ko'rinadi");
        return view('backoffice.product.index')
                ->with('products',$products)
                ->with('category',$categories);
    }
    ...
    public function Delete($id){
        ...
        $products = Product::all();
        $categories = Category::all();
        Alert::success("Mahsulot muvaffaqiyatli o'chirildi",'');
        return view('backoffice.product.index')
                ->with('products',$products)
                ->with('category',$categories);
